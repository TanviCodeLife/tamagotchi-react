...
function CharacterList(props){
  ...
  function handleChoosenCharacter(event){
    ...
    [{emoji: '\u{1f34c}', score: 1, q: 4}, {emoji: '\u{1f372}', score: 3, q: 2}, {emoji: '\u{1f34e}', score: 2, q: 3}],
    [{emoji: '\u{1f31a}', score: 1, q: 10}],
    [{emoji: '\u{1f6b4}', score: 2, q: 4}, {emoji: '\u{1f4d5}', score: 1, q: 6}, {emoji: '\u{1f31e}', score: 3, q: 3}]);
  }
